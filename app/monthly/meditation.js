...
// Creating Monthly Meditation Page And Exporting It As Default
export default function MonthlyMeditationPage() {
    // Returning JSX
    return (
        <SafeAreaView>
            <Stack.Screen
            ...
            />
            <ScrollAbleContainer>
                <Text style={textStyle.title}>Meditation's done this week:</Text>
                <CalenderComponent />
